namespace Frank.UblSharp.TendererQualification
{
    ...
    public partial class TendererQualificationType
    {
        ...
        [XmlIgnoreAttribute()]
        private List<Frank.UblSharp.CommonAggregateComponentsCommonAggregateComponents.TendererPartyQualificationType> _tendererPartyQualification;
        ...
        public List<Frank.UblSharp.CommonAggregateComponentsCommonAggregateComponents.TendererPartyQualificationType> TendererPartyQualification
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private List<Frank.UblSharp.CommonAggregateComponentsCommonAggregateComponents.EvidenceType> _evidence;
        ...
        public List<Frank.UblSharp.CommonAggregateComponentsCommonAggregateComponents.EvidenceType> Evidence
        {
            get
            {
                return _evidence;
