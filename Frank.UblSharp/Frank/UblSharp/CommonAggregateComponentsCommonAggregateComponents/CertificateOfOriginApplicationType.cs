...
namespace Frank.UblSharp.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class CertificateOfOriginApplicationType
    {
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("ReferenceID", Order=0, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("CertificateType", Order=1, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("ApplicationStatusCode", Order=2, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [DescriptionAttribute(@"<ccts:Component xmlns:ccts=""urn:un:unece:uncefact:documentation:2""><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Certificate Of Origin Application. Original_ Job Identifier. Identifier</ccts:DictionaryEntryName><ccts:Definition>The latest job number given to the CoO application. This is used by the system to keep track of amendments to or cancellation of any earlier applications.</ccts:Definition><ccts:Cardinality>1</ccts:Cardinality><ccts:ObjectClass>Certificate Of Origin Application</ccts:ObjectClass><ccts:PropertyTermQualifier>Original</ccts:PropertyTermQualifier><ccts:PropertyTerm>Job Identifier</ccts:PropertyTerm><ccts:RepresentationTerm>Identifier</ccts:RepresentationTerm><ccts:DataType>Identifier. Type</ccts:DataType></ccts:Component>")]
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("OriginalJobID", Order=3, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("PreviousJobID", Order=4, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [XmlElementAttribute("Remarks", Order=5, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("Shipment", Order=6)]
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("EndorserParty", Order=7)]
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("PreparationParty", Order=8)]
        ...
        [DescriptionAttribute(@"<ccts:Component xmlns:ccts=""urn:un:unece:uncefact:documentation:2""><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Certificate Of Origin Application. Issuer_ Party. Party</ccts:DictionaryEntryName><ccts:Definition>The organization authorized to issue the CoO requested by this application.</ccts:Definition><ccts:Cardinality>1</ccts:Cardinality><ccts:ObjectClass>Certificate Of Origin Application</ccts:ObjectClass><ccts:PropertyTermQualifier>Issuer</ccts:PropertyTermQualifier><ccts:PropertyTerm>Party</ccts:PropertyTerm><ccts:AssociatedObjectClass>Party</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Party</ccts:RepresentationTerm></ccts:Component>")]
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("IssuerParty", Order=9)]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("ExporterParty", Order=10)]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("ImporterParty", Order=11)]
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("IssuingCountry", Order=12)]
        ...
        [XmlElementAttribute("DocumentDistribution", Order=13)]
        ...
        [XmlElementAttribute("SupportingDocumentReference", Order=14)]
        ...
        [XmlElementAttribute("Signature", Order=15)]
