...
namespace Frank.UblSharp.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class PaymentMeansType
    {
        ...
        [XmlElementAttribute("PaymentMeansCode", Order=1, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("PaymentDueDate", Order=2, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("PaymentChannelCode", Order=3, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("InstructionID", Order=4, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [XmlElementAttribute("InstructionNote", Order=5, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        /// </summary>
        [DescriptionAttribute(@"<ccts:Component xmlns:ccts=""urn:un:unece:uncefact:documentation:2""><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Payment Means. Payment Identifier. Identifier</ccts:DictionaryEntryName><ccts:Definition>An identifier for a payment made using this means of payment.</ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Payment Means</ccts:ObjectClass><ccts:PropertyTerm>Payment Identifier</ccts:PropertyTerm><ccts:RepresentationTerm>Identifier</ccts:RepresentationTerm><ccts:DataType>Identifier. Type</ccts:DataType></ccts:Component>")]
        [XmlElementAttribute("PaymentID", Order=6, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("CardAccount", Order=7)]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("PayerFinancialAccount", Order=8)]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("PayeeFinancialAccount", Order=9)]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("CreditAccount", Order=10)]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("PaymentMandate", Order=11)]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("TradeFinancing", Order=12)]
