...
namespace Frank.UblSharp.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// </summary>
    [DescriptionAttribute(@"<ccts:Component xmlns:ccts=""urn:un:unece:uncefact:documentation:2""><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Consumption Correction. Details</ccts:DictionaryEntryName><ccts:Definition>The Statement of correction, for examples heating correction.</ccts:Definition><ccts:ObjectClass>Consumption Correction</ccts:ObjectClass></ccts:Component>")]
