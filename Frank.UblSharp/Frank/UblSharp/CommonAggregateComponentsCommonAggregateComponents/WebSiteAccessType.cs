...
namespace Frank.UblSharp.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class WebSiteAccessType
    {
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("Password", Order=1, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("Login", Order=2, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
