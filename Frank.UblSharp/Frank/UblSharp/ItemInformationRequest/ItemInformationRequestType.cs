...
namespace Frank.UblSharp.ItemInformationRequest
{
    ...
    public partial class ItemInformationRequestType
    {
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("Period", Order=11, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("ItemInformationRequestLine", Order=18, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
