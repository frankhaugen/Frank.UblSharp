...
namespace Frank.UblSharp.DocumentStatusRequest
{
    ...
    public partial class DocumentStatusRequestType
    {
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("TrackingID", Order=11, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("RequestedDocumentReference", Order=12, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
