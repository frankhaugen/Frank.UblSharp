...
namespace Frank.UblSharp.ExceptionCriteria
{
    ...
    public partial class ExceptionCriteriaType
    {
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("ValidityPeriod", Order=12, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("ExceptionCriteriaLine", Order=19, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
