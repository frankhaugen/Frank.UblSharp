...
namespace Frank.UblSharp.AwardedNotification
{
    ...
    public partial class AwardedNotificationType
    {
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("TenderResult", Order=17, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
        ...
        [XmlElementAttribute("FinalFinancialGuarantee", Order=18, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
