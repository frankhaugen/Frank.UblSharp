...
namespace Frank.UblSharp.TendererQualification
{
    ...
    public partial class TendererQualificationType
    {
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("PreviousVersionID", Order=13, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("TendererPartyQualification", Order=15, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
        ...
        [XmlElementAttribute("Evidence", Order=17, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
