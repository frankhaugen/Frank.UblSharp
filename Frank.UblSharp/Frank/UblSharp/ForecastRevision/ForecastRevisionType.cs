...
namespace Frank.UblSharp.ForecastRevision
{
    ...
    public partial class ForecastRevisionType
    {
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("RevisionStatusCode", Order=12, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [AllowNullAttribute()]
        [MaybeNullAttribute()]
        [XmlElementAttribute("PurposeCode", Order=13, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        ...
        [XmlElementAttribute("OriginalDocumentReference", Order=15, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("ForecastRevisionLine", Order=21, Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")]
