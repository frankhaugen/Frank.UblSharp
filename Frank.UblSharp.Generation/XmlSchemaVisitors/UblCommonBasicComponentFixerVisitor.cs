...
using Frank.UblSharp.Generation.Constants;
using Frank.UblSharp.Generation.Extensions;

namespace Frank.UblSharp.Generation.XmlSchemaVisitors;
...
public class UblCommonBasicComponentFixerVisitor : IAsyncVisitor<XmlSchemaSet>
{
    ...
    private static void FlattenCommonBasicComponents(XmlSchemaSet schemaSet)
    {
